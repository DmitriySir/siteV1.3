...
/* harmony import */ var _js_script2_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../js/script2.js */ "./src/js/script2.js");
/* harmony import */ var _js_script2_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_js_script2_js__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _node_modules_swiper_swiper_bundle_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_node_modules_swiper_swiper_bundle_js__WEBPACK_IMPORTED_MODULE_3__);
...
if (document.documentElement.clientWidth < 768) {
  ...
  }, _defineProperty(_Swiper, "direction", "horizontal"), _defineProperty(_Swiper, "simulateTouch", true), _defineProperty(_Swiper, "touchRatio", 1), _defineProperty(_Swiper, "touchAngel", 45), _defineProperty(_Swiper, "grabCursor", true), _defineProperty(_Swiper, "slidesPerView", 1.1), _defineProperty(_Swiper, "modules", [swiper__WEBPACK_IMPORTED_MODULE_0__["Navigation"], swiper__WEBPACK_IMPORTED_MODULE_0__["Pagination"]]), _Swiper));
}
...
document.querySelector("#burg").onclick = function () {
  var swr = document.querySelector('.section__wrapper');
  swr.classList.add("section__wrapper-active");
  swr.classList.add("wrapper-active");
  var swp = document.querySelector('.main__wrapper');
  swp.classList.add("main__wrapper-active");
};

document.querySelector("#burgCls").onclick = function () {
  var swr = document.querySelector('.section__wrapper');
  swr.classList.remove("section__wrapper-active");
  swr.classList.remove("wrapper-active");
  var swp = document.querySelector('.main__wrapper');
  swp.classList.remove("main__wrapper-active");
};

document.querySelector("#callBack").onclick = function () {
  var swr = document.querySelector('.call');
  swr.classList.add("call-active");
  var swp = document.querySelector('.section__wrapper');
  swp.classList.remove("section__wrapper-active");
  var swg = document.querySelector('.main__wrapper');
  swg.classList.add("main__wrapper-active");
  var swg = document.querySelector('.section__wrapper');
  swg.classList.add("section__wrapper-hidden");
};
...
document.querySelector("#callButton").onclick = function () {
  ...
  var swp = document.querySelector('.section__wrapper');
  swp.classList.remove("section__wrapper-active");
  var swd = document.querySelector('.main__wrapper');
  swd.classList.add("main__wrapper-active");
};

document.querySelector("#callBackCls").onclick = function () {
  var swr = document.querySelector('.call');
  swr.classList.remove("call-active");
  var swp = document.querySelector('.main__wrapper');
  swp.classList.remove("main__wrapper-active");
  var swr = document.querySelector('.section__wrapper');
  swr.classList.remove("section__wrapper-active");
  swr.classList.remove("wrapper-active");
  var swg = document.querySelector('.section__wrapper');
  swg.classList.remove("section__wrapper-hidden");
};

document.querySelector("#feedBack").onclick = function () {
  var swr = document.querySelector('.feedback');
  swr.classList.add("feedback-active");
  var swp = document.querySelector('.section__wrapper');
  swp.classList.remove("section__wrapper-active");
  var swg = document.querySelector('.main__wrapper');
  swg.classList.add("main__wrapper-active");
...
document.querySelector("#feedbackbutton").onclick = function () {
  var swr = document.querySelector('.feedback');
  swr.classList.add("feedback-active");
  var swp = document.querySelector('.section__wrapper');
  swp.classList.remove("section__wrapper-active");
...
document.querySelector("#feedBackCls").onclick = function () {
  var swr = document.querySelector('.feedback');
  swr.classList.remove("feedback-active");
  var swp = document.querySelector('.main__wrapper');
  swp.classList.remove("main__wrapper-active");
  var swr = document.querySelector('.section__wrapper');
  swr.classList.remove("section__wrapper-active");
...
document.querySelector("#btn").onclick = function () {
  var swr = document.querySelector('.swiper-wrapper');
  swr.classList.toggle("swiper-wrapper__active");
  var swr = document.querySelector('.showMore__button-arrow');
  swr.classList.toggle("showMore__button-arrow__active");
  var swb = document.querySelector('.showMore__button-text');
  swb.classList.toggle("showMore__button-text-active");
  var swd = document.querySelector('.showMore__button-hidden');
  swd.classList.toggle("showMore__button-hidden-active");
};

document.querySelector("#btn2").onclick = function () {
  var swr = document.querySelector('.swiper-wrapper__second');
  swr.classList.toggle("swiper-wrapper__active2");
  var swr = document.querySelector('.showMore__button-arrow2');
  swr.classList.toggle("showMore__button-arrow__active2");
  var swb = document.querySelector('.showMore__button-text2');
  swb.classList.toggle("showMore__button-text-active2");
  var swd = document.querySelector('.showMore__button-hidden2');
  swd.classList.toggle("showMore__button-hidden-active2");
};
